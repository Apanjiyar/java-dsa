...
A structured collection of DSA patterns and LeetCode problems to prepare for coding interviews.
...
If a problem contains these keywords, consider the **Two Pointer** approach:
- Sort / Sorted
- Merge
- Remove Duplicates
- Rearrange
